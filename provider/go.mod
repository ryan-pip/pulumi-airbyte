module github.com/ryan-pip/pulumi-airbyte/provider
...
require (
	...
	github.com/ryan-pip/terraform-provider-airbyte/shim v0.0.0
)
...
require (
	...
	github.com/ryan-pip/terraform-provider-airbyte v0.3.7 // indirect
...
replace (
	github.com/airbytehq/terraform-provider-airbyte => github.com/ryan-pip/terraform-provider-airbyte v0.3.7
	github.com/ryan-pip/terraform-provider-airbyte/shim => ./shim
)
