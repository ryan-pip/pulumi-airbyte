...
__all__ = [
    'GetDestinationSnowflakeResult',
    'AwaitableGetDestinationSnowflakeResult',
    'get_destination_snowflake',
    'get_destination_snowflake_output',
]

@pulumi.output_type
class GetDestinationSnowflakeResult:
    """
    ...
    @property
    @pulumi.getter
    def configuration(self) -> 'outputs.GetDestinationSnowflakeConfigurationResult':
...
class AwaitableGetDestinationSnowflakeResult(GetDestinationSnowflakeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDestinationSnowflakeResult(
...
def get_destination_snowflake(destination_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('airbyte:index/getDestinationSnowflake:getDestinationSnowflake', __args__, opts=opts, typ=GetDestinationSnowflakeResult).value

    return AwaitableGetDestinationSnowflakeResult(
...
@_utilities.lift_output_func(get_destination_snowflake)
