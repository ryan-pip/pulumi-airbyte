...
__all__ = [
    'GetDestinationPubsubResult',
    'AwaitableGetDestinationPubsubResult',
    'get_destination_pubsub',
    'get_destination_pubsub_output',
]

@pulumi.output_type
class GetDestinationPubsubResult:
    """
    ...
    @property
    @pulumi.getter
    def configuration(self) -> 'outputs.GetDestinationPubsubConfigurationResult':
...
class AwaitableGetDestinationPubsubResult(GetDestinationPubsubResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDestinationPubsubResult(
...
def get_destination_pubsub(destination_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('airbyte:index/getDestinationPubsub:getDestinationPubsub', __args__, opts=opts, typ=GetDestinationPubsubResult).value

    return AwaitableGetDestinationPubsubResult(
...
@_utilities.lift_output_func(get_destination_pubsub)
