...
class GetSourceLeverHiringResult:
    ...
    @property
    @pulumi.getter
    def configuration(self) -> 'outputs.GetSourceLeverHiringConfigurationResult':
...
def get_source_lever_hiring(secret_id: Optional[str] = None,
...
def get_source_lever_hiring_output(secret_id: Optional[pulumi.Input[Optional[str]]] = None,
