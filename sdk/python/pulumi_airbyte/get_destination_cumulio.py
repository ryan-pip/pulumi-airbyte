...
__all__ = [
    'GetDestinationCumulioResult',
    'AwaitableGetDestinationCumulioResult',
    'get_destination_cumulio',
    'get_destination_cumulio_output',
]

@pulumi.output_type
class GetDestinationCumulioResult:
    """
    ...
    @property
    @pulumi.getter
    def configuration(self) -> 'outputs.GetDestinationCumulioConfigurationResult':
...
class AwaitableGetDestinationCumulioResult(GetDestinationCumulioResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDestinationCumulioResult(
...
def get_destination_cumulio(destination_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('airbyte:index/getDestinationCumulio:getDestinationCumulio', __args__, opts=opts, typ=GetDestinationCumulioResult).value

    return AwaitableGetDestinationCumulioResult(
...
@_utilities.lift_output_func(get_destination_cumulio)
