...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `airbyte` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-airbyte
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-airbyte/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-airbyte/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-airbyte_darwin_amd64_v1
│   └── pulumi-resource-airbyte
├── pulumi-airbyte_darwin_arm64
│   └── pulumi-resource-airbyte
├── pulumi-airbyte_linux_amd64_v1
│   └── pulumi-resource-airbyte
├── pulumi-airbyte_linux_arm64
│   └── pulumi-resource-airbyte
├── pulumi-airbyte_windows_amd64_v1
│   └── pulumi-resource-airbyte.exe
└── pulumi-airbyte_windows_arm64
    └── pulumi-resource-airbyte.exe
```
