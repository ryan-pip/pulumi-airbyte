...
namespace Pulumi.Airbyte.Inputs
{
    ...
    public sealed class SourceAzureBlobStorageConfigurationGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SourceAzureBlobStorageConfigurationFormatGetArgs> Format { get; set; } = null!;

        [Input("sourceType", required: true)]
        public Input<string> SourceType { get; set; } = null!;

        public SourceAzureBlobStorageConfigurationGetArgs()
        {
        }
        public static new SourceAzureBlobStorageConfigurationGetArgs Empty => new SourceAzureBlobStorageConfigurationGetArgs();
    }
}
