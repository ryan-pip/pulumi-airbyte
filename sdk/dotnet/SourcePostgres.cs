...
{
    [AirbyteResourceType("airbyte:index/sourcePostgres:SourcePostgres")]
    public partial class SourcePostgres : global::Pulumi.CustomResource
    {
        [Output("configuration")]
        public Output<Outputs.SourcePostgresConfiguration> Configuration { get; private set; } = null!;
        ...
        public SourcePostgres(string name, SourcePostgresArgs args, CustomResourceOptions? options = null)
            : base("airbyte:index/sourcePostgres:SourcePostgres", name, args ?? new SourcePostgresArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SourcePostgres(string name, Input<string> id, SourcePostgresState? state = null, CustomResourceOptions? options = null)
            : base("airbyte:index/sourcePostgres:SourcePostgres", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SourcePostgresArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.SourcePostgresConfigurationArgs> Configuration { get; set; } = null!;
    ...
    {
        [Input("configuration")]
        public Input<Inputs.SourcePostgresConfigurationGetArgs>? Configuration { get; set; }
